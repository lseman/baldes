 ...
 *
 * This file declares the IPSolver interfaces and helper functions used by the BALDES solver.
 *
 */
...
public:
    ...
    ScalingFactors ruiz_scaling(Eigen::SparseMatrix<double> &A, Eigen::VectorXd &b, Eigen::VectorXd &c,
                                Eigen::VectorXd &lo, Eigen::VectorXd &hi);

    void unscale_solution(Eigen::VectorXd &x, Eigen::VectorXd &lambda, const ScalingFactors &factors);
};
