...
public:
    ...
    void sink_update_all(std::vector<SSPNode> &V, std::vector<double> &distance2src, int sink_id, int n);

    void sink_update_all_weight(std::vector<SSPNode> &V, std::vector<double> &distance2src, int sink_id, int n);
